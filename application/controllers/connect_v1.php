...
class Connect_v1 extends REST_Controller
{
    ...
    public function loginFromID_post(){
        if($this->input->post("id_iscrizione") != false){
            ...
            $random_id = substr($id, -3);
            $username = $this->input->post("username");
            $pwd = $this->input->post("password");

            $return = $this->login->doLoginFromID($real_id, $random_id, $username, $pwd);
        // 200
            if($return[0] == 1){
    ...
    public function motivational_get(){
        $this->load->model("app/v1/motivational");        
    ...
    public function old_partecipazioni_get(){
        ...
        if(isset($request[AUTH_REQUEST]) && $this->login->controlToken($request[AUTH_REQUEST])){
            ...
            $old_partecipazioni = $this->eventi->old_eventi($id_cliente,"PS");
    ...
    public function new_partecipazioni_get(){
        ...
        if(isset($request[AUTH_REQUEST]) && $this->login->controlToken($request[AUTH_REQUEST])){
            ...
            $new_partecipazioni = $this->eventi->new_eventi($id_cliente,"PS");        
    ...
    public function eventi_get(){
        ...
        $eventi = $this->eventi->list_eventi("PS", $id_cliente);
        if($eventi != NULL) {
    ...
    public function comunicazioni_get(){
        $this->load->model("app/v1/comunicazioni");
    ...
    public function getProfessioni_get(){
        $this->load->model("app/v1/servizi");
